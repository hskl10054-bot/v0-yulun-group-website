      ...
      <section style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", paddingTop: "5rem" }}>
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "6rem 4rem 6rem 6rem" }}>
          ...
          <h1 ref={addRef(1)} className="serif" style={{ ...fadeStyle, transitionDelay: "0.15s", fontSize: "clamp(3.5rem, 6vw, 5.5rem)", fontWeight: 300, lineHeight: 1.05, marginBottom: "2rem" }}>
            為你的空間<br /><span style={{ display: "inline-flex", alignItems: "center", gap: "0.3rem" }}><em style={{ fontStyle: "italic", color: "#8C8479" }}>注入魔法</em><svg width="80" height="80" viewBox="0 0 120 120" fill="#D4A0A0" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0, marginLeft: "0.1rem" }}><path d="M50,50 L42,5 L58,50Z M50,50 L78,8 L58,45Z M50,50 L118,38 L56,58Z M50,50 L82,88 L56,58Z M50,50 L58,115 L44,58Z M50,50 L15,98 L44,58Z M50,50 L2,62 L44,44Z M50,50 L16,12 L44,44Z" /></svg></span>
          </h1>
