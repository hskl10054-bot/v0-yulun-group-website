...
const services = [
  { num: "01", icon: HardHat, name: "全室裝修施工", desc: "由集團旗下的「裕綸室內裝修工程」負責，確保設計圖紙完美落地。" },
  { num: "02", icon: Wrench, name: "舊屋翻新", desc: "包含老屋的結構改良與現代美學注入，讓老房子煥然一新。" },
  { num: "03", icon: ClipboardList, name: "商業空間施工", desc: "針對咖啡廳、辦公室、品牌門市的功能性施工，打造吸引人且實用的商業環境。" },
  { num: "04", icon: ShieldCheck, name: "工程監管", desc: "專業的工地現場統籌與進度管控，確保施工品質與進度如期完成。" },
  { num: "05", icon: FileText, name: "設計規劃", desc: "平面配置、立面設計、材料挑選、軟裝陳設，提供完整的空間設計規劃服務。" },
  { num: "06", icon: Users, name: "設計施工整合", desc: "與空房子室內設計深度合作，從諮詢、設計到施工的一站式（一條龍）服務。" },
]

const projects = [
  { title: "北區三房全室翻新", type: "全室裝修・2024", color: "#8A7A68", colorTo: "#6A5C4C", span2: true },
  { title: "西屯商辦裝修", type: "商業空間・2024", color: "#9E8E7A", colorTo: "#7A6A58", span2: false },
  { title: "南區老公寓改造", type: "舊屋翻新・2023", color: "#B4A490", colorTo: "#8C7C6A", span2: false },
  { title: "精品衛浴工程", type: "局部工程・2023", color: "#7A6A58", colorTo: "#5A4C3C", span2: false },
  { title: "大里透天厝裝修", type: "全室裝修・2023", color: "#C0B0A0", colorTo: "#9A8A78", span2: false },
]
...
export default function ConstructionPage() {
  ...
  return (
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", background: "#FAF8F4", color: "#2A2520", letterSpacing: "0.05em" }}>
      ...
      <section style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", paddingTop: "5rem" }}>
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "6rem 4rem 6rem 6rem" }}>
          ...
          <h1 ref={addRef(1)} className="serif" style={{ ...fadeStyle, transitionDelay: "0.15s", fontSize: "clamp(3.2rem, 5.5vw, 5.5rem)", fontWeight: 300, lineHeight: 1.05, marginBottom: "2rem" }}>
            精準施工<br /><em style={{ fontStyle: "italic", color: "#8C8479" }}>守護每一吋</em><br />空間品質
          </h1>
          <p ref={addRef(2)} className="noto" style={{ ...fadeStyle, transitionDelay: "0.3s", fontSize: "0.88rem", lineHeight: 2, color: "#8C8479", maxWidth: 380, marginBottom: "3rem", fontWeight: 300 }}>
            裕綸集團（空房子室內設計）提供從諮詢、設計到施工的一站式服務。核心理念在於「不做複製品」，根據屋主的生活習慣、個性與夢想，將空間轉化為具備溫度的生活語彙。2年保固，安心無憂。
          </p>
      ...
      {/* STRENGTHS */}
      <section style={{ padding: "8rem 6rem", background: "#F0EBE3" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 ref={addRef(5)} className="serif" style={{ ...fadeStyle, transitionDelay: "0.15s", fontSize: "2.8rem", fontWeight: 300, marginBottom: "1.5rem" }}>為什麼選擇我們</h2>
      ...
      <section id="projects" style={{ padding: "6rem 0", background: "#F0EBE3" }}>
        <div style={{ padding: "0 6rem", marginBottom: "3rem", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            ...
            <h2 className="serif" style={{ fontSize: "2.8rem", fontWeight: 300 }}>施工案例</h2>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gridTemplateRows: "300px 300px", gap: "2px" }}>
          {projects.map((p, i) => (
            <div key={p.title} className="portfolio-item" style={{ position: "relative", overflow: "hidden", gridRow: i === 0 ? "span 2" : undefined }}>
              <div className="portfolio-bg" style={{ width: "100%", height: "100%", background: `linear-gradient(135deg, ${p.color} 0%, ${p.colorTo} 100%)`, transition: "transform 0.6s ease" }} />
      ...
      <section style={{ padding: "8rem 6rem", background: "#2A2520" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "2rem" }}>
          {testimonials.map((t, i) => (
            <div key={t.name} ref={addRef(15 + i)} style={{ ...fadeStyle, transitionDelay: `${i * 0.15}s`, padding: "2.5rem", border: "0.5px solid rgba(255,255,255,0.1)" }}>
      ...
      <section id="contact" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "70vh" }}>
        ...
        <div style={{ background: "#2A2520", padding: "6rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <h2 className="serif" style={{ fontSize: "2.8rem", fontWeight: 300, color: "#FAF8F4", marginBottom: "2.5rem" }}>申請估價</h2>
      ...
      <footer style={{ background: "#1A1510", padding: "2.5rem 6rem", display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "0.5px solid rgba(255,255,255,0.05)" }}>
        <span className="serif" style={{ fontSize: "1.1rem", fontWeight: 300, letterSpacing: "0.15em", color: "rgba(255,255,255,0.45)" }}>裕綸室內裝修有限公司</span>
        <p style={{ fontSize: "0.6rem", letterSpacing: "0.2em", color: "rgba(255,255,255,0.2)", textTransform: "uppercase" }}>© 2026 裕綸室內裝修有限公司・裕綸集團</p>
        <div style={{ display: "flex", gap: "2rem" }}>
          {[{name:"Instagram",url:"https://www.instagram.com/human_design.space/"}].map(s => (
            <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer" style={{ fontSize: "0.6rem", letterSpacing: "0.2em", color: "rgba(255,255,255,0.3)", textDecoration: "none", textTransform: "uppercase" }}>{s.name}</a>
          ))}
        </div>
      </footer>
    </div>
