  ...
  return (
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", background: "#FAF8F4", color: "#2A2520", letterSpacing: "0.05em" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.5rem 4rem", background: "rgba(250,248,244,0.92)", backdropFilter: "blur(12px)", borderBottom: "0.5px solid #E8E3DA" }}>
        ...
        <span className="serif" style={{ fontSize: "1.3rem", fontWeight: 300, letterSpacing: "0.15em", color: "#2A2520" }}>同齊咖啡</span>
        <a href="#stores" style={{ fontSize: "0.68rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#6B4E31", textDecoration: "none" }}>門市資訊</a>
      </nav>
      ...
      <section style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr", paddingTop: "5rem" }}>
        ...
        <div style={{ background: "#6B4E31", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "1rem" }}>
      ...
      <section style={{ padding: "8rem 6rem", background: "#F5F0E8" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 ref={addRef(5)} className="serif" style={{ ...fadeStyle, transitionDelay: "0.15s", fontSize: "2.8rem", fontWeight: 300, marginBottom: "1.5rem" }}>品牌特色</h2>
      ...
      {/* STORES */}
      <section id="stores" style={{ padding: "8rem 6rem", background: "#FAF8F4" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "4rem", borderBottom: "0.5px solid #E8E3DA", paddingBottom: "2rem" }}>
          <div>
            ...
            <h2 className="serif" style={{ fontSize: "2.8rem", fontWeight: 300 }}>門市資訊</h2>
          </div>
        </div>
