...
export function BrandSplit() {
  return (
    <section id="brands" className="flex flex-col md:flex-row">
      ...
      <BrandCard title="裕綸室內裝修工程" subtitle="Construction Engineering" description="打造有溫度的生活空間 — 從諮詢、設計到施工的一站式服務，不做複製品，將空間轉化為生活語彙。" imageSrc="/images/construction-brand.jpg" imageAlt="裕綸室內裝修工程" href="/construction" />
    </section>
  )
}
