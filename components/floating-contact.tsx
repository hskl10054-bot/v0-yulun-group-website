  ...
  return (
    <div className="fixed bottom-5 right-4 z-[9990] flex flex-col items-center gap-3">
      ...
      >
        ...
        <span className="rounded-full bg-white px-2 py-0.5 text-[10px] font-medium tracking-wider text-[#6B4E31] shadow-md ring-1 ring-black/5">
          線上詢問
        </span>
      </a>
      ...
      {showTop && (
        ...
        >
          ...
          <span className="rounded-full bg-white px-2 py-0.5 text-[10px] font-medium tracking-[0.18em] text-[#6B4E31] shadow-md ring-1 ring-black/5">
            TOP
          </span>
        </button>
      )}
