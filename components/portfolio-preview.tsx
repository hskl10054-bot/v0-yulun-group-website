            ...
            return (
              <Link key={slug} href={`/works/${slug}`} className="group w-[88vw] shrink-0 snap-start sm:w-[70vw] md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.334rem)]">
                ...
                <div className="mt-6">
                  ...
                  {seoTags(c).length > 0 && (
                    <p className="mt-2 truncate text-[1.05rem] font-normal tracking-wide md:text-[1.15rem]" style={{ color: colors.portfolio_accent }}>
                      {seoTags(c).join("　｜　")}
                    </p>
                  )}
                  {c.story && (
                    <p className="mt-3 line-clamp-2 text-[1.05rem] font-light leading-[1.9] md:text-[1.15rem]" style={{ color: colors.portfolio_heading, opacity: 0.72 }}>
                      {c.story}
                    </p>
                  )}
                </div>
