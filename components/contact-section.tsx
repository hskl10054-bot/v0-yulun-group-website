        ...
        <div className="flex flex-col gap-5">
          {[
            ...
            <div key={label} style={{ marginBottom: "1.5rem" }}>
              ...
              <input type={type} placeholder={placeholder} className="serif w-full bg-transparent font-light tracking-wide placeholder:text-white/25 outline-none transition-colors" style={{ fontSize: "1.05rem", color: colors.footer_text, border: "none", boxShadow: "0 1px 0 rgba(255,255,255,0.15)", paddingBottom: "0.5rem", paddingTop: "0.25rem" }} />
            </div>
          ))}
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <textarea placeholder="請簡單描述您的空間需求或想法..." rows={3} className="serif w-full resize-none bg-transparent font-light tracking-wide placeholder:text-white/25 outline-none transition-colors" style={{ fontSize: "1.05rem", color: colors.footer_text, border: "none", boxShadow: "0 1px 0 rgba(255,255,255,0.15)", paddingBottom: "0.5rem", paddingTop: "0.25rem" }} />
          </div>
