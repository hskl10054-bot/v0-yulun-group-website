    ...
    <section className="py-24 md:py-32" style={{ backgroundColor: colors.testimonials_bg }}>
      <div className="mx-auto max-w-[100rem] px-6 md:px-12">
        <div className="mb-12 border-b pb-5 md:mb-14" style={{ borderColor: colors.testimonials_card_border }}>
          ...
          <h2 className="text-3xl font-bold tracking-[0.12em] md:text-4xl" style={{ color: colors.testimonials_heading }}>客戶怎麼說</h2>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((t) => (
            <div key={t.name} className="p-8 transition-colors duration-500" style={{ borderWidth: "1px", borderStyle: "solid", borderColor: colors.testimonials_card_border }}>
              <p className="mb-6 text-[1.05rem] font-light leading-relaxed md:text-[1.15rem]" style={{ color: colors.testimonials_text, lineHeight: 2, ...getListItemStyle(content, "testimonials", t.sortOrder, "description", "home") }}>「{t.quote}」</p>
