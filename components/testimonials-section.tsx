        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((t) => (
            <div key={t.name} className="p-8 transition-colors duration-500" style={{ borderWidth: "1px", borderStyle: "solid", borderColor: colors.testimonials_card_border }}>
              <p className="mb-6 font-light leading-relaxed" style={{ color: colors.testimonials_text, fontSize: "0.95rem", lineHeight: 2, ...getListItemStyle(content, "testimonials", t.sortOrder, "description", "home") }}>「{t.quote}」</p>
