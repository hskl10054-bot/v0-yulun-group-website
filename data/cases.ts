...
// 照片為 Cloudinary（cloud name: dfvmjmwb7，動態資料夾）網址。
// public id ＝乾淨檔名（無資料夾前綴）：<enName slug>-hero、<enName slug>-1、-2…
...
export const CASES: CaseStudy[] = [
  {
    ...
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/smoke-and-stone-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/smoke-and-stone-1", caption: "客廳量體化解穿堂風，落地窗引入採光" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/smoke-and-stone-2", caption: "曲面櫃門與黑色霧面，從玄關就定調" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/smoke-and-stone-3", caption: "多功能空間，胡桃木質帶來溫度" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/smoke-and-stone-4", caption: "木紋檯面與霧面抽屜的細膩銜接" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "常日", enName: "Everyday", tagline: "家的樣子，是最貼近日常的剛剛好",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/everyday-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/everyday-1", caption: "開闊的客廳與紙燈柔光，是日常的一隅" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/everyday-2", caption: "臥室木作衣櫃，霧面玻璃拉門透著柔光" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/everyday-3", caption: "白與木的廚房，開放層架點出溫度" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/everyday-4", caption: "衣櫃內部：吊掛與抽屜，收納一目了然" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "無痕", enName: "Seamless", tagline: "收納與門，都隱進牆面裡",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/seamless-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/seamless-1", caption: "直紋推拉門衣櫃，光影斜落在櫃面" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/seamless-2", caption: "衣櫃內部：吊掛、層板、抽屜分區明確" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/seamless-3", caption: "獨立更衣間，鏡面與木質放大空間" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/seamless-4", caption: "主臥整面收納，順勢連到後方更衣動線" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "長案", enName: "The Long Table", tagline: "沙發背後一道長桌，讓客廳能工作也能生活",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/the-long-table-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/the-long-table-1", caption: "沙發背後的長桌，是書桌，也是生活的角落" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/the-long-table-2", caption: "長桌延伸，串起客廳、餐廚與收納" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/the-long-table-3", caption: "弧形長虹玻璃屏風，引光也輕輕分界" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/the-long-table-4", caption: "調光簾濾進的光，落在餐桌一隅" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "留白", enName: "Negative Space", tagline: "極簡不是少，是留白裡的呼吸與溫度",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/negative-space-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/negative-space-1", caption: "米色皮沙發面向陽台，紗簾濾入柔光" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/negative-space-2", caption: "餐廳整面白色收納，留一格放對講機與隨手小物" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/negative-space-3", caption: "大理石餐桌與玻璃吊燈，是留白中的一點溫度" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "木格", enName: "Lattice", tagline: "讓視線延伸，空間簡約而舒緩",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lattice-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lattice-1", caption: "暖光下的客餐廳，紅白吊燈點出生活感" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lattice-2", caption: "黑框玻璃隔間廚房，擋油煙也保留通透" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lattice-3", caption: "從玄關延伸的整面系統櫃，收納藏於牆面" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "摩卡", enName: "Mocha", tagline: "摩卡色的溫暖，讓家成為最安定的所在",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/mocha-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/mocha-1", caption: "黑框玻璃隔間界定餐廚，霧鏡吊燈點出層次" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/mocha-2", caption: "摩卡色餐邊櫃，鏡面背牆放大空間" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "曜", enName: "Onyx", tagline: "黑白灰之間，低調而優雅的輕奢",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/onyx-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/onyx-1", caption: "餐廚與黑玻展示櫃相鄰，白色廚房在後通透延伸" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/onyx-2", caption: "深色木質電視牆，沉穩內斂的視覺重心" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "悠流", enName: "Flow", tagline: "開放通透，讓光與生活自在流動",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/flow-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/flow-1", caption: "米色沙發與木質家具，客廳溫潤放鬆" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/flow-2", caption: "餐廳串連客廳與廚房，動線開放流暢" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/flow-3", caption: "整面格子書牆，收納與展示一次到位" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "歇", enName: "Repose", tagline: "奶茶色裡，把臥室留給安靜的休息",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/repose-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/repose-1", caption: "床頭收納整合層板，黑色擺件點出侘寂感" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/repose-2", caption: "轉角結合衣櫃與書桌，機能藏在簡潔線條裡" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/repose-3", caption: "頂天衣櫃與抽屜，收納量足卻不顯壓迫" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/repose-4", caption: "深色層板與黑陶擺件，奶茶色裡的一點重量" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "光格", enName: "Lightframe", tagline: "光影落在層架之間，鋪出溫柔的日常",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lightframe-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lightframe-1", caption: "發光開放層架界定客餐廳，材質紋理在光影中浮現" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/lightframe-2", caption: "多功能室以整面層板與收納，留白而有餘裕" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "新生", enName: "Renewal", tagline: "老屋翻新，讓每一間都重新被好好生活",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/renewal-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/renewal-1", caption: "整面採光配書桌與迷你廚房，一個人住明亮舒適" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/renewal-2", caption: "頂天衣櫃結合開放層板，小坪數也有充足收納" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/renewal-3", caption: "床尾結合書桌與滑門衣櫃，動線俐落不佔空間" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/renewal-4", caption: "迷你廚房、衣櫃、衛浴一應俱全，一個人住剛剛好" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "恰好", enName: "Just Right", tagline: "不多不少，剛好是你想要的生活",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/just-right-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/just-right-1", caption: "大理石電視牆鋪滿整面，搭木質懸浮櫃體俐落大器" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/just-right-2", caption: "主臥以微水泥、木皮與深色衣櫃，鋪出沉穩的暖度" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/just-right-3", caption: "床頭微水泥牆嵌燈帶，柔和光暈包覆睡眠區" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/just-right-4", caption: "架高地板結合書桌與收納，多功能房一坪都不浪費" },
    ],
  },
  {
    cat: RESIDENTIAL, zhName: "預見", enName: "Preview", tagline: "在動工之前，先看見家的樣子",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/preview-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/preview-1", caption: "灰布沙發面向採光，客廳留出開闊的活動尺度" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/preview-2", caption: "微水泥電視牆搭懸浮木質櫃，溫潤又俐落" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/preview-3", caption: "開放式餐廚整合電器收納，圓桌串起餐廳與廚房" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/preview-4", caption: "電器收納櫃內嵌咖啡機與微波爐，機能藏得剛好" },
    ],
  },
  {
    cat: COMMERCIAL, zhName: "酵境", enName: "Catalyst", tagline: "把酵素科學，變成走得進去的空間",
    hero: "https://res.cloudinary.com/dfvmjmwb7/image/upload/catalyst-hero",
    ...
    gallery: [
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/catalyst-1", caption: "圓柱展示台以不鏽鋼飾帶收邊，搭配六角壁龕陳列 001 ENZYME 酵素產品，延續分子與實驗室語彙" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/catalyst-2", caption: "整面酵素分子結構壓花牆，把化學式變成低調的藝術" },
      { src: "https://res.cloudinary.com/dfvmjmwb7/image/upload/catalyst-3", caption: "錐形瓶、量杯盛裝飲品，延續實驗室的精密與乾淨" },
    ],
  },
];
